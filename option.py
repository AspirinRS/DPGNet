...
class Options():
    ...
    def init(self):
        ...
        self.parser.add_argument('--name', type=str, default='experiment', help='experiment name')
        self.parser.add_argument('--dataroot', type=str, default='./datasets')
        self.parser.add_argument('--dataset', type=str, default='LEVIR-CD', help='dataset name: LEVIR-CD, WHU-CD, SYSU-CD')
        ...
        self.parser.add_argument('--num_workers', type=int, default=0, help='#threads for loading data')
        self.parser.add_argument('--lr', type=float, default=5e-4)#1e-5
